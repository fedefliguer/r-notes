...
_map y map2 iteran en paralelo sobre dos listas, por lo que no valen para casos en los que, por ejemplo, se quiera el producto de cacda elemento en c(1:10) por cada elemento en c(11:20), una lista de 100 resultados en vez de 10. Para ese caso hay que usar cross2 de la librería purrr.
